    ...
    <main style={{ background: '#0B0B0F', minHeight: '100vh' }}>
      ...
      <section style={{ position: 'relative', overflow: 'hidden', padding: '80px 0' }}>
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 80px', position: 'relative', zIndex: 1 }}>
          <Link href="/kurslar" style={{ color: '#A0A0B0', fontSize: '13px', textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '6px', marginBottom: '32px' }}>
            ← Kurslara qayit
          </Link>
          <div style={{ display: 'flex', gap: '60px', alignItems: 'flex-start' }}>
            <div style={{ flex: 1 }}>
              <span style={{ background: course.color, color: '#fff', fontSize: '11px', fontWeight: 700, padding: '5px 14px', borderRadius: '100px', marginBottom: '20px', display: 'inline-block' }}>
              ...
              <div style={{ display: 'flex', gap: '24px', marginBottom: '40px', flexWrap: 'wrap' }}>
                {[
                  ...
                  { icon: '👥', label: course.students + ' telebe' },
                  { icon: '⭐', label: course.rating + ' reytinq' },
                ].map((s, i) => (
                  <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'rgba(255,255,255,0.06)', padding: '8px 16px', borderRadius: '100px', border: '1px solid rgba(255,255,255,0.1)' }}>
                    ...
                    <span style={{ color: '#FFFFFF', fontSize: '13px', fontWeight: 500 }}>{s.label}</span>
                  </div>
                ))}
              </div>
              <div style={{ display: 'flex', gap: '16px' }}>
                <Link href="/qeydiyyat" style={{ textDecoration: 'none', background: '#FF2CA8', color: '#FFFFFF', fontWeight: 700, fontSize: '15px', padding: '16px 32px', borderRadius: '10px', boxShadow: '0px 8px 28px rgba(255,44,168,0.45)' }}>
                  Indi Qeydiyyatdan Kec →
                </Link>
                <a href="https://wa.me/994000000000" style={{ textDecoration: 'none', background: '#25D366', color: '#FFFFFF', fontWeight: 600, fontSize: '15px', padding: '16px 24px', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  💬 WhatsApp
                </a>
              </div>
            </div>
            ...
            <div style={{ background: '#13131A', border: '1px solid rgba(255,44,168,0.25)', borderRadius: '20px', padding: '32px', minWidth: '300px', flexShrink: 0 }}>
              ...
              <Link href="/qeydiyyat" style={{ display: 'block', textAlign: 'center', textDecoration: 'none', background: '#FF2CA8', color: '#FFFFFF', fontWeight: 700, fontSize: '15px', padding: '16px', borderRadius: '10px', boxShadow: '0px 4px 16px rgba(255,44,168,0.45)' }}>
                Qeydiyyatdan Kec →
              </Link>
        ...
        <div style={{ maxWidth: '1440px', margin: '0 auto', padding: '0 80px', display: 'grid', gridTemplateColumns: '1fr 360px', gap: '60px' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {course.curriculum.map((week, i) => (
                  <div key={i} style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '20px 24px', transition: 'border-color 0.2s' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                      {week.topics.map((t, j) => (
                        <span key={j} style={{ background: 'rgba(255,255,255,0.06)', color: '#A0A0B0', fontSize: '12px', padding: '5px 12px', borderRadius: '6px' }}>{t}</span>
                      ))}
                    </div>
                  </div>
                ))}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            <div style={{ background: 'rgba(255,44,168,0.08)', border: '1px solid rgba(255,44,168,0.25)', borderRadius: '16px', padding: '24px', textAlign: 'center' }}>
              ...
              <a href="https://wa.me/994000000000" style={{ display: 'block', textDecoration: 'none', background: '#25D366', color: '#FFFFFF', fontWeight: 700, fontSize: '13px', padding: '12px', borderRadius: '8px' }}>
                💬 WhatsApp ile Yaz
              </a>
            </div>
          </div>
